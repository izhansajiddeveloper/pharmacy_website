...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        echo '<script>setTimeout(function(){ window.location.href = "view_sale.php?id=' . $sale_id . '"; }, 2000);</script>';
    } catch (Exception $e) {
...
<body class="min-h-screen overflow-x-hidden">
                ...
                <div class="glass-card rounded-2xl p-4 mb-6 bg-gradient-to-r from-green-50 to-green-25 border border-green-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-green-500 text-sm mt-1">Redirecting to view page...</p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <script>
        ...
        const existingItems = <?php echo json_encode($existing_items_array); ?>;
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-4">
                    <div class="lg:col-span-2">
                        ...
                        <select name="medicine_id[]" 
                                class="medicine-select w-full form-input px-3 py-2 rounded-lg"
                                data-item-id="${itemId}"
